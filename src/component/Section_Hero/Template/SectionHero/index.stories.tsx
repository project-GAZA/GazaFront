...
export default {
  title: 'stories/Section_Hero/Template/SectionHero',
...
export const Desktop: ComponentStory<typeof SectionHero> = Template.bind({});
Desktop.parameters = {
  viewport: {
    defaultViewport: 'desktop',
  },
};
export const Table: ComponentStory<typeof SectionHero> = Template.bind({});
Table.parameters = {
  viewport: {
