/* InputSection */
const inputtopMessage = '모두 메세지로 마음을 전해보세요.';
const inputtopMessage2 = `가자지구 아이들에게 <br /> 응원 메세지를 남겨주세요!`;
const inputtopMessageInBox = '마음을 전해요!';
const inputcheerMessage = '응원메세지 작성하기';
const inputcheerMessageInfo = `
    작성한 메시지는
    <br /> 이 사이트에서 <strong>공유</strong>돼요!
`;
const inputcheerGo = '작성하러 가기';
const inputDonateMessage = '후원금 전달하기';
const inputDonateMessageInfo = `
    작성한 메시지는
    <br /> 실제 <strong>책자</strong>에 들어갈 거에요!
`;
const inputDonateMessageGo = '작성하러 가기';
const modalCommentHeader = '응원메세지 한 줄 보내기';
const modalCommentInputPlaceholder = '응원메세지를 입력해주세요';
const modalCommentInputNickPlaceholder = '작성자를 입력해주세요';
...
const showInfoTopText = '“아이들은 잘못이 없습니다!”';
const WordCloud = [
  '# GAZA',
  '희망 메세지를',
  '희망 메세지를 전달합니다.',
...
export const ShowInfo = {
  mobile: {
    ...
    ExplainText: `        10월 7일에 시작된 <strong>이스라엘 하마스 간의 분쟁</strong>은
    <br /> 가자지구의 <strong>많은 아이들에게 깊은 상처</strong>를
    남겼습니다.
    <br /> 이 아픔은 향후 분쟁이 끝난 가자지구 안에서 다시금
    <br /> <strong>세상을 향한 분노와 증오의 불씨</strong>
    로 남게 될 것이며,
    <br /> 이렇게 된다면 <strong>전 세계 평화에도 큰 위협</strong>이 될 수
    있습니다.
    <br />
    <br />
    <strong class="ExplainStrong">이제 우리가 행동할 때입니다.</strong>
    <br />
    <br /> <strong class="redstrong">가자지구 아이들을 위한 희망 메시지 전달 프로젝트</strong>
    로
    <br /> 가자지구의 아이들이 분쟁의 어둠을 넘어
    <br /> <strong>밝은 내일을 향해 나아가도록</strong> 돕고자 합니다.
    <br /> 우리의 관심과 사랑이 이 아이들에게
    <br /> <strong>긍정적인 변화</strong>를 가져오고,
    <br /> <strong>전 세계에 평화의 메시지</strong>를 전파할 것입니다.`,
    WordCloud,
  },
  pc: {
    TopText: showInfoTopText,
    ExplainText: `        10월 7일에 시작된 <strong>이스라엘 하마스 간의 분쟁</strong>은 가자지구의 <strong>많은 아이들에게 깊은 상처</strong>를
    남겼습니다.
    <br /> 이 아픔은 향후 분쟁이 끝난 가자지구 안에서 다시금 <strong>세상을 향한 분노와 증오의 불씨</strong> 로 남게 될 것이며,
    <br /> 이렇게 된다면 <strong>전 세계 평화에도 큰 위협</strong>이 될 수 있습니다.
    <br />
    <br />
    <strong class="ExplainStrong">이제 우리가 행동할 때입니다.</strong>
    <br />
    <br /> <strong class="redstrong">가자지구 아이들을 위한 희망 메시지 전달 프로젝트</strong>
    로
    <br /> 가자지구의 아이들이 분쟁의 어둠을 넘어 <strong>밝은 내일을 향해 나아가도록</strong> 돕고자 합니다.
