...
const ShowInfo = () => {
  return (
    <Box className="SecondSection mobile">
      <Text className="SecondTopText">“아이들은 잘못이 없습니다!”</Text>
      <Text className="SecondExplainText">
        10월 7일에 시작된{' '}
        <span style={{ fontWeight: 'bold' }}>이스라엘 하마스 간의 분쟁</span>은
        <br /> 가자지구의{' '}
        <span style={{ fontWeight: 'bold' }}>많은 아이들에게 깊은 상처</span>를
        남겼습니다.
        ...
        로 남게 될 것이며,
        <br /> 이렇게 된다면{' '}
        <span style={{ fontWeight: 'bold' }}>전 세계 평화에도 큰 위협</span>이
        될 수 있습니다.
        <br />
        <br />
        ...
        <br /> <span style={{ fontWeight: 'bold' }}>긍정적인 변화</span>를
        가져오고,
        <br />{' '}
        <span style={{ fontWeight: 'bold' }}>전 세계에 평화의 메시지</span>를
        전파할 것입니다.
      </Text>
      <Box className="EarthWrapper">
        <Box className="Pin" />
        <Box className="PinShadow" />
